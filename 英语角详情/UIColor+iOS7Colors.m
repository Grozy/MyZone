...
+ (instancetype)iOS7scrollViewBackGroundColor;
{
    return [UIColor colorWithRed:0.94f green:0.94f blue:0.94f alpha:1.0f];
}

+ (instancetype)iOS7hightlightBludColor;
{
    return [UIColor colorWithRed:0.25f green:0.55f blue:0.89f alpha:1.0f];
}
